 ...
 */
package cn.org.eshow_framwork.task.thread;
...
public class AbTaskPool {
	...
	/** 单例对象 The http pool. */
	private static cn.org.eshow_framwork.task.thread.AbTaskPool abTaskPool = null;
    ...
    private AbTaskPool() {
        ...
        mExecutorService = cn.org.eshow_framwork.task.thread.AbThreadFactory.getExecutorService();
    } 
