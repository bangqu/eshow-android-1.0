 ...
 */
package cn.org.eshow_framwork.soap;
...
import cn.org.eshow_framwork.http.AbHttpStatus;
...
public class AbSoapClient {
	...
	public void call(final String url,final String nameSpace,final String methodName, AbSoapParams Params,
			final cn.org.eshow_framwork.soap.AbSoapListener listener) {
		this.mParams = Params;

		if (!AbAppUtil.isNetworkAvailable(mContext)) {
			listener.sendFailureMessage(AbHttpStatus.CONNECT_FAILURE_CODE,
					AbAppConfig.CONNECT_EXCEPTION, new cn.org.eshow_framwork.global.AbAppException(
