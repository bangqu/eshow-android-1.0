 ...
 */
package cn.org.eshow_framwork.db.storage;
import android.content.Context;

import java.util.List;

import cn.org.eshow_framwork.db.orm.dao.AbDBDaoImpl;
import cn.org.eshow_framwork.db.storage.AbSqliteStorageListener.AbDataDeleteListener;
import cn.org.eshow_framwork.db.storage.AbSqliteStorageListener.AbDataInsertListListener;
import cn.org.eshow_framwork.db.storage.AbSqliteStorageListener.AbDataInsertListener;
import cn.org.eshow_framwork.db.storage.AbSqliteStorageListener.AbDataSelectListener;
import cn.org.eshow_framwork.db.storage.AbSqliteStorageListener.AbDataUpdateListener;
import cn.org.eshow_framwork.task.AbTaskItem;
import cn.org.eshow_framwork.task.AbTaskListListener;
import cn.org.eshow_framwork.task.AbTaskObjectListener;
import cn.org.eshow_framwork.task.thread.AbTaskQueue;
	...
	public <T> void insertData(final T entity,final AbDBDaoImpl<T> dao, final AbDataInsertListener paramDataInsertListener){
		 ...
		 if (entity != null){
	    	...
	    	item.setListener(new AbTaskObjectListener() {
	    		...
	    		//@SupprAbsWarnings({ "hiding", "unchecked" })
				@Override
