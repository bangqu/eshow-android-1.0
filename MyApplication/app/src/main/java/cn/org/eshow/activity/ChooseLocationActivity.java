...
import cn.org.eshow.fragment.AroundPlaceFragment;
import cn.org.eshow.fragment.AroundPlaceSlidingFragment;
...
public class ChooseLocationActivity extends CommonActivity implements LocationSource,AMapLocationListener,AMap.OnCameraChangeListener{
    ...
    private void initMap() {
        ...
        if (aMap == null) {
            aMap = mvMap.getMap();
            ESLogUtil.i(mContext, "最大缩放比例：" + aMap.getMaxZoomLevel() + "，最小缩放比例：" + aMap.getMinZoomLevel());
            // 自定义系统定位小蓝点
    ...
    public void onLocationChanged(AMapLocation aMapLocation) {
        ESLogUtil.i(mContext, "onLocationChanged ");
        if (mListener != null && aMapLocation != null) {
            if (aMapLocation != null
                ...
                showAround(location);
                ESLogUtil.d(mContext,"location:"+location);
            } else {
