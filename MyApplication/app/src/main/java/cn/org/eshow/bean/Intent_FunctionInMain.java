...
import cn.org.eshow.activity.MapActivity_;
import cn.org.eshow.activity.PayWebViewActivity;
import cn.org.eshow.activity.ShareActivity_;
import cn.org.eshow.bluetooth.BluetoothActivity_;
import cn.org.eshow.common.SharedPrefUtil;
import cn.org.eshow.music.MusicListActivity_;
...
public class Intent_FunctionInMain {
    ...
    void onPay(Context context){
        if(SharedPrefUtil.isLogin(context)){
            ...
            ESLogUtil.i(context,"支付请求地址："+url);
