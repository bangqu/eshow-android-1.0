...
import cn.org.eshow.bean.Enum_ThirdType;
import cn.org.eshow.bluetooth.StringUtil;
...
import cn.org.eshow.view.LoginAutoCompleteEdit;
...
public class LoginActivity extends CommonActivity {
            ...
            public void onFailure(int statusCode, String content, Throwable error) {
                ...
                try {
                    ...
                    if(rr==-5){
                        ...
                        ESToastUtil.showToast(mContext, ret.getString("msg"));
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    void onWechatLogin() {
        ...
        ESToastUtil.showToast(mContext,"功能正在完善开发中...");
    ...
    ESResponseListener thirdLoginResListener = new ESResponseListener(mContext) {
        ...
        public void onFailure(int statusCode, String content, Throwable error) {
            ...
            ESToastUtil.showToast(mContext, content);
        }
    };
}
