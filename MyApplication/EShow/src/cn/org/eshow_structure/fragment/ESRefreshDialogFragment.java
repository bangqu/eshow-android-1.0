 ...
 *
 */
public class ESRefreshDialogFragment extends ESDialogFragment {
	 ...
	 * argument.
	 */
	public static ESRefreshDialogFragment newInstance(int style, int theme) {
		//不用单例模式
		ESRefreshDialogFragment f = new ESRefreshDialogFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		parent.setMinimumWidth(ESViewUtil.scaleValue(this.getActivity(), 400));
