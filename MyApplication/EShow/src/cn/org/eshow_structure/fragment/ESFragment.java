...
import cn.org.eshow_structure.util.ESAnimationUtil;
...
public class ESFragment extends Fragment {
	...
	public void showLoadView() {
		...
		ESViewUtil.removeSelfFromParent(mLoadView);
	...
	public void showRefreshView() {
		...
		ESViewUtil.removeSelfFromParent(mRefreshView);
	...
	public void showContentView() {
		...
		rootView.removeAllViews();
		ESViewUtil.removeSelfFromParent(mContentView);
	...
	public void load(View v){
		...
		ESAnimationUtil.playRotateAnimation(mIndeterminateView, 300, Animation.INFINITE,
				Animation.RESTART);
	}
