 ...
 */
package cn.org.eshow_structure.fragment;
 ...
 *
 */
public class ESSampleDialogFragment extends DialogFragment {
	 ...
	 */
	public static ESSampleDialogFragment newInstance(int style, int theme) {
	 ...
	 * @return the ab sample dialog fragment
	 */
	public static ESSampleDialogFragment newInstance(int style, int theme,int gravity) {
		ESSampleDialogFragment f = new ESSampleDialogFragment();
