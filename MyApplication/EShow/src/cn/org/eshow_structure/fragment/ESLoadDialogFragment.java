 ...
 *
 */
public class ESLoadDialogFragment extends ESDialogFragment {
	 ...
	 * argument.
	 */
	public static ESLoadDialogFragment newInstance(int style, int theme) {
		ESLoadDialogFragment f = new ESLoadDialogFragment();
