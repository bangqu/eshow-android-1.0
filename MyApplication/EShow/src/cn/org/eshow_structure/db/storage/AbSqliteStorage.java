 ...
 */
package cn.org.eshow_structure.db.storage;

import android.content.Context;

import cn.org.eshow_structure.db.orm.dao.ESDBDaoImpl;
import cn.org.eshow_structure.db.storage.AbSqliteStorageListener.AbDataDeleteListener;
import cn.org.eshow_structure.db.storage.AbSqliteStorageListener.AbDataInsertListListener;
import cn.org.eshow_structure.db.storage.AbSqliteStorageListener.AbDataInsertListener;
import cn.org.eshow_structure.db.storage.AbSqliteStorageListener.AbDataSelectListener;
import cn.org.eshow_structure.db.storage.AbSqliteStorageListener.AbDataUpdateListener;
import cn.org.eshow_structure.task.ESTaskItem;
import cn.org.eshow_structure.task.ESTaskListListener;
import cn.org.eshow_structure.task.ESTaskObjectListener;
import cn.org.eshow_structure.task.thread.ESTaskQueue;
...
public class AbSqliteStorage {
	...
	/** 队列. */
	private static ESTaskQueue mAbTask = null;
	 ...
	 */
	public <T> void insertData(final T entity,final ESDBDaoImpl<T> dao, final AbDataInsertListener paramDataInsertListener){
	 ...
	 * @param paramDataInsertListener 返回监听器
	 */
	public <T> void insertData(final List<T> entityList,final ESDBDaoImpl<T> dao, final AbDataInsertListListener paramDataInsertListListener){
		 if (entityList != null){
	 ...
	 * @param paramDataInsertListener 返回监听器
	 */
	public <T> void findData(final AbStorageQuery storageQuery,final ESDBDaoImpl<T> dao, final AbDataSelectListener paramDataSelectListener){
		     
	    	final ESTaskItem item = new ESTaskItem();
	    	item.setListener(new ESTaskListListener() {
	 ...
	 * @param paramDataInsertListener 返回监听器
	 */
	public <T> void updateData(final T entity,final ESDBDaoImpl<T> dao, final AbDataUpdateListener paramDataUpdateListener){
	 ...
	 * @param paramDataInsertListener 返回监听器
	 */
	public <T> void updateData(final List<T> entityList,final ESDBDaoImpl<T> dao, final AbDataUpdateListener paramDataUpdateListener){
	 ...
	 * @param paramDataInsertListener 返回监听器
	 */
	public <T> void deleteData(final AbStorageQuery storageQuery,final ESDBDaoImpl<T> dao, final AbDataDeleteListener paramDataDeleteListener){
