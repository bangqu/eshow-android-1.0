 ...
 *
 */
public class ESAnalogClock extends View {
	 ...
	 */
	public ESAnalogClock(Context context, Drawable dial, Drawable hourHand,
	...
	private void onTimeChanged() {
		...
		mChanged = true;
		ESLogUtil.d(ESAnalogClock.class, "时间改变:mHour:" + mHour + ",mMinutes:" + mMinutes + ",mSecond:" + mSecond);
