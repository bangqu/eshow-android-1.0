 ...
 *
 */
public class ESNumberClock extends View {
	 ...
	 */
	public ESNumberClock(Context context, Drawable timeBg, Drawable timeColon,
	...
	private void onTimeChanged() {
		...
		mSecond =  ESStrUtil.strFormat2(String.valueOf(mCalendar.second));
