 ...
 *
 */
public class ESFocusView extends LinearLayout implements OnFocusChangeListener{
     ...
     */
    public ESFocusView(Context context){
        this(context, null);
    }
     ...
     */
    public ESFocusView(Context context, AttributeSet attrs){
     ...
     */
    public ESFocusView(Context context, AttributeSet attrs, int defStyle){
        super(context, attrs);
