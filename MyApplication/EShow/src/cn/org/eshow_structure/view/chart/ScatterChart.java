...
public class ScatterChart extends XYChart {
   ...
   * @see cn.org.eshow.view.chart.XYChart#setDatasetRenderer(cn.org.eshow.view.chart.XYMultipleSeriesDataset, XYMultipleSeriesRenderer)
   * @author: amsoft.cn
   ...
   * @see cn.org.eshow.view.chart.XYChart#clickableAreasForPoints(float[], double[], float, int, int)
   * @author: amsoft.cn
   * @date：2013-6-17 上午9:04:49
   */
  @Override
