...
/**
 * 页面滚动切换,实现焦点触发和Touch，适用于电视开发.
 *
 */
public class ESSlidingPageView extends ViewGroup {
	
	/** 记录日志的标记. */
	private String TAG = ESSlidingPageView.class.getSimpleName();
	 ...
	 */
	public ESSlidingPageView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
