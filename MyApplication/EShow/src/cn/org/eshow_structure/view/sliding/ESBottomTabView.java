...
import cn.org.eshow_structure.view.sample.ESViewPager;
...
public class ESBottomTabView extends LinearLayout {
	...
	/** tab的列表. */
	private ArrayList<ESTabItemView> tabItemList = null;
	...
	public ESBottomTabView(Context context, AttributeSet attrs) {
		...
		if(!(this.context instanceof FragmentActivity)){
			ESLogUtil.e(ESBottomTabView.class, "构造AbSlidingTabView的参数context,必须是FragmentActivity的实例。");
		}
	...
	public void setTabPadding(int left, int top, int right, int bottom) {
		for(int i = 0;i<tabItemList.size();i++){
			ESTabItemView tabView = tabItemList.get(i);
