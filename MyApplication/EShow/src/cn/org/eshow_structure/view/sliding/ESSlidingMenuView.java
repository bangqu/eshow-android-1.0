 ...
 *
 */
public class ESSlidingMenuView extends ViewGroup {
	 ...
	 */
	public ESSlidingMenuView(Context context) {
		super(context);
	 ...
	 */
	public ESSlidingMenuView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			ESLogUtil.d(ESSlidingMenuView.class, "--dispatchTouchEvent ACTION_DOWN--");
			...
			if (mTouchState == TOUCH_STATE_RESTART) {
				...
				ESLogUtil.d(ESSlidingMenuView.class, "--dispatchTouchEvent ACTION_DOWN return false--");
				return false;
			}
			break;
		case MotionEvent.ACTION_MOVE:
			ESLogUtil.d(ESSlidingMenuView.class, "--dispatchTouchEvent ACTION_MOVE--");
			mVelocityTracker.computeCurrentVelocity(1000,ViewConfiguration.getMaximumFlingVelocity());
			if (mScrollState == SCROLL_STATE_ALLOW && getWidth() - (int) ev.getX() < mWidth) {
				ESLogUtil.d(ESSlidingMenuView.class, "--dispatchTouchEvent ACTION_MOVE return true--");
				return true;
			}
			break;
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		switch (ev.getAction()) {
		case MotionEvent.ACTION_DOWN:
			ESLogUtil.d(ESSlidingMenuView.class, "--onInterceptTouchEvent ACTION_DOWN--");
			mTouchState = mScroller.isFinished() ? TOUCH_STATE_RESTART : TOUCH_STATE_SCROLLING;
			if (mTouchState==TOUCH_STATE_SCROLLING) {
				ESLogUtil.d(ESSlidingMenuView.class, "--onInterceptTouchEvent ACTION_DOWN return false--");
				return false;
			}
			break;

		case MotionEvent.ACTION_MOVE:
			ESLogUtil.d(ESSlidingMenuView.class, "--onInterceptTouchEvent ACTION_MOVE--");
			mOnClick = false;
			mVelocityTracker.computeCurrentVelocity(1000,ViewConfiguration.getMaximumFlingVelocity());
			if (mScrollState == SCROLL_STATE_ALLOW && Math.abs(mVelocityTracker.getXVelocity()) > 200) {
				ESLogUtil.d(ESSlidingMenuView.class, "--onInterceptTouchEvent ACTION_MOVE return true--");
				return true;
			}
			break;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			ESLogUtil.d(ESSlidingMenuView.class, "--onTouchEvent ACTION_DOWN--");
			mTouchState = mScroller.isFinished() ? TOUCH_STATE_RESTART : TOUCH_STATE_SCROLLING;
			if (mTouchState==TOUCH_STATE_SCROLLING) {
				ESLogUtil.d(ESSlidingMenuView.class, "--onTouchEvent ACTION_DOWN return false--");
				return false;
			}
			break;

		case MotionEvent.ACTION_MOVE:
			ESLogUtil.d(ESSlidingMenuView.class, "--onTouchEvent ACTION_MOVE--");
			mVelocityTracker.computeCurrentVelocity(1000,ViewConfiguration.getMaximumFlingVelocity());
