    ...
    public ESSlidingTabView(Fragment fragment) {
        ...
        initView();
  		if(VERSION.SDK_INT <= 17){	
  			ESLogUtil.e(ESSlidingTabView.class, "AbSlidingTabView(Fragment fragment) 要求最低SDK版本17");
  		    return;
  		}
    ...
    public void initView(){
    	this.setOrientation(LinearLayout.VERTICAL);
 		...
 		if(!(this.context instanceof FragmentActivity)){
 			ESLogUtil.e(ESSlidingTabView.class, "构造AbSlidingTabView的参数context,必须是FragmentActivity的实例。");
 		}
    }
