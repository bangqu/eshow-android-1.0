 ...
 */
package cn.org.eshow_structure.view.ioc;
 ...
 * @see AbIocEventEvent
 */
public class ESIocEventListener implements OnClickListener, OnLongClickListener, OnItemClickListener, OnItemSelectedListener,OnItemLongClickListener {
	 ...
	 */
	public ESIocEventListener(Object handler) {
	 ...
	 */
	public ESIocEventListener click(String method){
	 ...
	 * @return the ab ioc event listener
	 */
	public ESIocEventListener longClick(String method){
	 ...
	 * @return the ab ioc event listener
	 */
	public ESIocEventListener itemLongClick(String method){
	 ...
	 * @return the ab ioc event listener
	 */
	public ESIocEventListener itemClick(String method){
	 ...
	 * @return the ab ioc event listener
	 */
	public ESIocEventListener select(String method){
	 ...
	 * @return the ab ioc event listener
	 */
	public ESIocEventListener noSelect(String method){
	...
	private Object invokeClickMethod(Object handler, String methodName,  Object... params){
		...
		try{   
			...
			if(method!=null)
				...
				throw new ESAppException("no such method:"+methodName);
		}catch(Exception e){
			e.printStackTrace();
		}
	...
	private boolean invokeItemLongClickMethod(Object handler, String methodName,  Object... params){
		...
		try{   
			if(handler == null){
				throw new ESAppException("invokeItemLongClickMethod: handler is null :");
			}
