 ...
 */
package cn.org.eshow_structure.view.progress;
...
public class ESHorizontalProgressBar extends View {
	 ...
	 */
	public ESHorizontalProgressBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		pathPaint  = new Paint();
		// 设置是否抗锯齿
