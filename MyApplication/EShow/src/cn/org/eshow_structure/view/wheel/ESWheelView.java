 ...
 *
 */
public class ESWheelView extends View {
	...
	// Wheel Values
	/** The adapter. */
	private ESWheelAdapter adapter = null;
	 ...
	 */
	public ESWheelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @param attrs the attrs
	 */
	public ESWheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * @param context the context
	 */
	public ESWheelView(Context context) {
		super(context);
		initData(context);
	}
	 ...
	 * @return the adapter
	 */
	public ESWheelAdapter getAdapter() {
		return adapter;
	}
	 ...
	 */
	public void setAdapter(ESWheelAdapter adapter) {
	...
	private int getMaxTextLength() {
		ESWheelAdapter adapter = getAdapter();
		if (adapter == null) {
			return 0;
		}
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		if (maxLength > 0) {
			//一个字符宽度
			float textWidth = (int) ESGraphicUtil.getStringWidth("0", labelPaint);
			//不算lable的宽度
		...
		if (label != null && label.length() > 0) {
			labelWidth = (int) ESGraphicUtil.getStringWidth(label, labelPaint);
		}
	...
	public void setValueTextSize(int textSize) {
		this.valueTextSize = ESViewUtil.scaleTextValue(mContext, textSize);
	...
	public void setLabelTextSize(int labelTextSize) {
		this.labelTextSize = ESViewUtil.scaleTextValue(mContext, labelTextSize);
	}
	...
	public interface AbOnWheelScrollListener {
		 ...
		 */
		void onScrollingStarted(ESWheelView wheel);
		
		/**
		 * Callback method to be invoked when scrolling ended.
		 * @param wheel the wheel view whose state has changed.
		 */
		void onScrollingFinished(ESWheelView wheel);
	}
	...
	public interface AbOnWheelChangedListener {
		 ...
		 */
		void onChanged(ESWheelView wheel, int oldValue, int newValue);
	}
