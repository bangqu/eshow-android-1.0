...
public class HighlightView {
     ...
     */
    private void init() {
        mResizeDrawableDiagonal = ESImageUtil.bitmapToDrawable(ESFileUtil.getBitmapFromSrc("image/crop_big.png"));
        mResizeDrawableDiagonal2 = ESImageUtil.bitmapToDrawable(ESFileUtil.getBitmapFromSrc("image/crop_small.png"));
    }
