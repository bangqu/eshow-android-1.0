...
public class ESExpandTabView extends LinearLayout implements OnDismissListener {
	...
	public ESExpandTabView(Context context) {
		super(context);
		init(context);
	}

	public ESExpandTabView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
