...
public class ESTabListAdapter extends ArrayAdapter<ESMenuItem> {

	private Context mContext;
	private List<ESMenuItem> mListData;
	...
	public ESTabListAdapter(Context context, List<ESMenuItem> listData, int selectedResId, int normalResId) {
