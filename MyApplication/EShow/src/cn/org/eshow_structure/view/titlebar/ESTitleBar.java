 ...
 */
package cn.org.eshow_structure.view.titlebar;
 ...
 *
 */
public class ESTitleBar extends LinearLayout {
	 ...
	 */
	public ESTitleBar(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void ininTitleBar(Context context){
		...
		titleTextBtn.setTextSize(ESViewUtil.scaleTextValue(context, 20));
		...
		titleSmallTextBtn.setTextSize(ESViewUtil.scaleTextValue(context, 15));
	...
	public void setTitleTextSize(int titleTextSize) {
		this.titleTextBtn.setTextSize(ESViewUtil.scaleTextValue(activity, titleTextSize));
	}
	...
	public void setTitleSmallTextSize(int titleSmallTextSize) {
		this.titleSmallTextBtn.setTextSize(ESViewUtil.scaleTextValue(activity, titleSmallTextSize));
	}
	...
	public void setTitleBarGravity(int gravity1,int gravity2) {
		ESViewUtil.measureView(this.logoView);
		ESViewUtil.measureView(this.rightLayout);
	...
	public void addRightView(View rightView) {
		...
		ESViewUtil.scaleContentView((ViewGroup) rightView);
	...
	public void addRightView(int resId) {
		...
		ESViewUtil.scaleContentView(view);
	...
	public void setTitleBarHeight(int height) {
		...
		params.height = ESViewUtil.scaleValue(activity, height);
