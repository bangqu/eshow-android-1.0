 ...
 *
 */
public class ESListViewFooter extends LinearLayout {
	 ...
	 */
	public ESListViewFooter(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 */
	public ESListViewFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	...
	private void initView(Context context) {
		...
		footerView.setMinimumHeight(ESViewUtil.scaleValue(mContext, 100));
		footerTextView = new TextView(context);  
		footerTextView.setGravity(Gravity.CENTER_VERTICAL);
		setTextColor(Color.rgb(107, 107, 107));
		ESViewUtil.setTextSize(footerTextView, 30);
		
		ESViewUtil.setPadding(footerView, 0, 10, 0, 10);
		...
		layoutParamsWW.rightMargin = ESViewUtil.scaleValue(mContext, 10);
