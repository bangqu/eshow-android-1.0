 ...
 */
public class ESMultiColumnListView extends ScrollView{
	...
	/**  Adapter. */
	private ESMultiColumnListAdapter mAdapter = null;
	
	/**  Adapter改变的监听器. */
	private AdapterDataSetObserver mDataSetObserver;
	
	/**  已加载的View. */
	private List<ESViewInfo> mItems = null;
	 ...
	 */
	public ESMultiColumnListView(Context context) {
		this(context,null);
	}
	 ...
	 */
	public ESMultiColumnListView(Context context, AttributeSet attrs) {
	 ...
	 */
	public ESMultiColumnListView(Context context, AttributeSet attrs, int defStyle) {
		...
		mItems = new ArrayList<ESViewInfo>();
	}
	 ...
	 * @return the adapter
	 */
	public ESMultiColumnListAdapter getAdapter() {
		return mAdapter;
	}
	 ...
	 */
	public void setAdapter(ESMultiColumnListAdapter adapter) {
    ...
    protected void layoutChildren() {
    	ESLogUtil.d(ESMultiColumnListView.class, "layoutChildren");
    	...
    	if(mAdapter != null){
    		...
    		for (int i = 0; i < mItemCount; i++) {
    			ESViewInfo viewInfo = mAdapter.getView(i, null, null);
    ...
    protected void addChildren() {
    	ESLogUtil.d(ESMultiColumnListView.class, "addChildren");
    	if(mAdapter != null){
	 ...
	 */
	private void findColumnToAdd(ESViewInfo viewInfo) {
	...
	public boolean checkVisibility(int position) {
		ESViewInfo viewInfo = mItems.get(position);
	...
	class AdapterDataSetObserver extends DataSetObserver {
		...
		public void onChanged() {
			ESLogUtil.d(ESMultiColumnListView.class, "onChanged");
			//判断是刷新还是添加
    		int count = mAdapter.getCount();
    		if(count > mItems.size()){
    			//添加
