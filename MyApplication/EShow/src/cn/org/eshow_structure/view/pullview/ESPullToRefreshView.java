 ...
 */
package cn.org.eshow_structure.view.pullview;
 ...
 *
 */
public class ESPullToRefreshView extends LinearLayout {
     ...
     * header view.
     */
    private ESListViewHeader mHeaderView;

    /**
     * footer view.
     */
    private ESListViewFooter mFooterView;
     ...
     */
    public ESPullToRefreshView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
     ...
     * @param context the context
     */
    public ESPullToRefreshView(Context context) {
        super(context);
        init(context);
    }
    ...
    private void addHeaderView() {
        mHeaderView = new ESListViewHeader(mContext);
    ...
    private void addFooterView() {
        ...
        mFooterView = new ESListViewFooter(mContext);
    ...
    private void initContentAdapterView() {
        ...
        for (int i = 0; i < count - 1; ++i) {
            ...
            if (view instanceof AdapterView<?>) {
                ...
                ESLogUtil.d(tag, "view instanceof AdapterView<?>");
            }
    ...
    private void headerPrepareToRefresh(int deltaY) {
        ...
        if (newTopMargin >= 0 && mHeaderView.getState() != ESListViewHeader.STATE_REFRESHING) {
            //提示松开刷新
            mHeaderView.setState(ESListViewHeader.STATE_READY);

        } else if (newTopMargin < 0 && newTopMargin > -mHeaderViewHeight) {
            //提示下拉刷新
            mHeaderView.setState(ESListViewHeader.STATE_NORMAL);
        }
    }
    ...
    private void footerPrepareToRefresh(int deltaY) {
        ...
        if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight) && mFooterView.getState() != ESListViewFooter.STATE_LOADING) {
            mFooterView.setState(ESListViewFooter.STATE_READY);
        } else if (Math.abs(newTopMargin) < (mHeaderViewHeight + mFooterViewHeight)) {
            mFooterView.setState(ESListViewFooter.STATE_LOADING);
        }
    }
    ...
    public void headerRefreshing() {
        ...
        mHeaderView.setState(ESListViewHeader.STATE_REFRESHING);
    ...
    public void onHeaderRefreshFinish() {
        ...
        if (mAdapterView != null) {
            ...
            if (mCount > 0) {
                ...
                mFooterView.setState(ESListViewFooter.STATE_EMPTY);
            }
        } else {
            mFooterView.setState(ESListViewFooter.STATE_READY);
        }
    ...
    public void onFooterLoadFinish() {
        ...
        if (mAdapterView != null) {
            ...
            if (countNew > mCount) {
                ...
                mFooterView.setState(ESListViewFooter.STATE_NO);
            }
        } else {
            mFooterView.setState(ESListViewFooter.STATE_READY);
        }
     ...
     */
    public ESListViewHeader getHeaderView() {
        return mHeaderView;
    }
     ...
     */
    public ESListViewFooter getFooterView() {
        return mFooterView;
    }
    ...
    public interface OnFooterLoadListener {
         ...
         * @param view the view
         */
        public void onFooterLoad(ESPullToRefreshView view);
    }
    ...
    public interface OnHeaderRefreshListener {
         ...
         * @param view the view
         */
        public void onHeaderRefresh(ESPullToRefreshView view);
    }
