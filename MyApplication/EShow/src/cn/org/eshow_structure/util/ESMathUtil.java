...
import cn.org.eshow_structure.model.ESCircle;
import cn.org.eshow_structure.model.ESPoint;
...
public class ESMathUtil {
   ...
   */
	 ...
	 * @return
	 */
    public static boolean pointOnCircle(ESPoint point,ESCircle c1,ESCircle c2){
    ...
    /**
 	 ...
 	 * @return
 	 */
     public static boolean pointOnCircle(ESPoint point,ESCircle c1,ESCircle c2,float offset){
     ...
     * @return
     */
    public static boolean pointInCircle(ESPoint point,ESCircle circle){
     ...
     * @return
     */
    public static double getDistance(ESPoint p1,ESPoint p2) {
	 ...
	 * @return
	 */
	public static List<ESPoint> circleCrossoverPoint(ESCircle circle1,ESCircle circle2){
		List<ESPoint> pointList = new ArrayList<ESPoint>();
		//第一个圆的参数方程:
		// x = r1 * cosCita + x1
		// y = r1 * sinCita + y1
		...
		Set<ESPoint> pointSet = new HashSet<ESPoint>();
		ESPoint p1_1 = new ESPoint(x_1,y_1_1);
		if(pointOnCircle(p1_1,circle1,circle2)){
			pointSet.add(p1_1);
		}
		
		ESPoint p1_2 = new ESPoint(x_1,y_1_2);
		...
		ESPoint p2_1 = new ESPoint(x_2,y_2_1);
		if(pointOnCircle(p2_1,circle1,circle2)){
			pointSet.add(p2_1);
		}
		
		ESPoint p2_2 = new ESPoint(x_2,y_2_2);
		if(pointOnCircle(p2_2,circle1,circle2)){
			pointSet.add(p2_2);
		}
		for(Iterator<ESPoint> iter = pointSet.iterator();iter.hasNext();){
			ESPoint point = (ESPoint)iter.next();
			pointList.add(point);
        }  
		return pointList;
	}
