...
import cn.org.eshow_structure.fragment.ESAlertDialogFragment;
import cn.org.eshow_structure.fragment.ESAlertDialogFragment.AbDialogOnClickListener;
import cn.org.eshow_structure.fragment.ESDialogFragment.AbDialogOnLoadListener;
import cn.org.eshow_structure.fragment.ESLoadDialogFragment;
import cn.org.eshow_structure.fragment.ESProgressDialogFragment;
import cn.org.eshow_structure.fragment.ESRefreshDialogFragment;
import cn.org.eshow_structure.fragment.ESSampleDialogFragment;
...
public class ESDialogUtil {
	...
	public static ESSampleDialogFragment showFullScreenDialog(View view) {
        ...
        ESSampleDialogFragment newFragment = ESSampleDialogFragment.newInstance(DialogFragment.STYLE_NORMAL, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
	...
	public static ESSampleDialogFragment showDialog(View view,int gravity,int style) {
		FragmentActivity activity = (FragmentActivity)view.getContext();
        // Create and show the dialog.
        ESSampleDialogFragment newFragment = ESSampleDialogFragment.newInstance(DialogFragment.STYLE_NO_TITLE, style, gravity);
        newFragment.setContentView(view);
	 ...
	 * @return
	 */
	public static ESSampleDialogFragment showDialog(View view,int style,DialogInterface.OnCancelListener onCancelListener) {
	 ...
	 * @return
	 */
	public static ESSampleDialogFragment showDialog(View view,int gravity,int style,DialogInterface.OnCancelListener onCancelListener) {
		FragmentActivity activity = (FragmentActivity)view.getContext();
        // Create and show the dialog.
        ESSampleDialogFragment newFragment = ESSampleDialogFragment.newInstance(DialogFragment.STYLE_NO_TITLE, style, gravity);
        newFragment.setContentView(view);
	 ...
	 * @return
	 */
	public static ESSampleDialogFragment showDialog(View view,int animEnter, int animExit, int animPopEnter, int animPopExit,DialogInterface.OnCancelListener onCancelListener) {
	 ...
	 * @return
	 */
	public static ESSampleDialogFragment showDialog(View view,int animEnter, int animExit, int animPopEnter, int animPopExit,int style,DialogInterface.OnCancelListener onCancelListener) {
	 ...
	 * @return
	 */
	public static ESSampleDialogFragment showDialog(View view,int animEnter, int animExit, int animPopEnter, int animPopExit,int gravity,int style,DialogInterface.OnCancelListener onCancelListener) {
		FragmentActivity activity = (FragmentActivity)view.getContext();
        // Create and show the dialog.
        ESSampleDialogFragment newFragment = ESSampleDialogFragment.newInstance(DialogFragment.STYLE_NO_TITLE, style, gravity);
        newFragment.setContentView(view);
	 ...
	 * @return
	 */
	public static ESSampleDialogFragment showDialog(View view,int animEnter, int animExit, int animPopEnter, int animPopExit) {
	 ...
	 * @return
	 */
	public static ESSampleDialogFragment showDialog(View view,int animEnter, int animExit, int animPopEnter, int animPopExit,int style) {
	 ...
	 * @return
	 */
	public static ESSampleDialogFragment showDialog(View view,int animEnter, int animExit, int animPopEnter, int animPopExit,int gravity,int style) {
		FragmentActivity activity = (FragmentActivity)view.getContext();
        // Create and show the dialog.
        ESSampleDialogFragment newFragment = ESSampleDialogFragment.newInstance(DialogFragment.STYLE_NO_TITLE, style, gravity);
        newFragment.setContentView(view);
	 ...
	 */
	public static ESAlertDialogFragment showAlertDialog(Context context,int icon,String title,String message,AbDialogOnClickListener onClickListener) {
		FragmentActivity activity = (FragmentActivity)context; 
		ESAlertDialogFragment newFragment = ESAlertDialogFragment.newInstance(icon, title, message, null, onClickListener);
		FragmentTransaction ft = activity.getFragmentManager().beginTransaction();
        // 指定一个系统转场动画   
        ft.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);  
		newFragment.show(ft, dialogTag);
	 ...
	 * @param onClickListener 点击确认按钮的事件监听
	 */
	public static ESAlertDialogFragment showAlertDialog(Context context,String title,String message,AbDialogOnClickListener onClickListener) {
		FragmentActivity activity = (FragmentActivity)context;
		ESAlertDialogFragment newFragment = ESAlertDialogFragment.newInstance(0, title, message, null, onClickListener);
		FragmentTransaction ft = activity.getFragmentManager().beginTransaction();
        // 指定一个系统转场动画   
        ft.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);  
		newFragment.show(ft, dialogTag);
	 ...
	 * @param onClickListener 点击确认按钮的事件监听
	 */
	public static ESAlertDialogFragment showAlertDialog(int icon,String title,View view,AbDialogOnClickListener onClickListener) {
		FragmentActivity activity = (FragmentActivity)view.getContext();
		ESAlertDialogFragment newFragment = ESAlertDialogFragment.newInstance(icon, title, null, view, onClickListener);
		FragmentTransaction ft = activity.getFragmentManager().beginTransaction();
        // 指定一个系统转场动画   
        ft.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);  
		newFragment.show(ft, dialogTag);
	 ...
	 * @param onClickListener 点击确认按钮的事件监听
	 */
	public static ESAlertDialogFragment showAlertDialog(String title,View view,AbDialogOnClickListener onClickListener) {
		FragmentActivity activity = (FragmentActivity)view.getContext(); 
		ESAlertDialogFragment newFragment = ESAlertDialogFragment.newInstance(0, title, null, view, onClickListener);
		FragmentTransaction ft = activity.getFragmentManager().beginTransaction();
        // 指定一个系统转场动画   
        ft.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);  
		newFragment.show(ft, dialogTag);
	 ...
	 */
	public static ESProgressDialogFragment showProgressDialog(Context context,int indeterminateDrawable,String message) {
		FragmentActivity activity = (FragmentActivity)context; 
	 ...
	 * @param message the message
	 */
	public static ESLoadDialogFragment showLoadDialog(Context context,int indeterminateDrawable,String message,AbDialogOnLoadListener abDialogOnLoadListener) {
	 ...
	 * @param style
	 */
	public static ESLoadDialogFragment showLoadDialog(Context context,int indeterminateDrawable,String message,int style) {
		FragmentActivity activity = (FragmentActivity)context; 
	 ...
	 * @param abDialogOnRefreshListener
	 */
	public static ESRefreshDialogFragment showRefreshDialog(Context context,int indeterminateDrawable,String message) {
	 ...
	 * @return
	 */
	public static ESRefreshDialogFragment showRefreshDialog(Context context,int indeterminateDrawable,String message,AbDialogOnLoadListener abDialogOnLoadListener) {
	 ...
	 * @param style
	 */
	public static ESRefreshDialogFragment showRefreshDialog(Context context,int indeterminateDrawable,String message,int style) {
		FragmentActivity activity = (FragmentActivity)context; 
		ESRefreshDialogFragment newFragment = ESRefreshDialogFragment.newInstance(DialogFragment.STYLE_NO_TITLE, style);
		newFragment.setIndeterminateDrawable(indeterminateDrawable);
		newFragment.setMessage(message);
