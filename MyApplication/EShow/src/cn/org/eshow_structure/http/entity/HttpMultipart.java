...
package cn.org.eshow_structure.http.entity;
...
import cn.org.eshow_structure.http.ESHttpResponseListener;
import cn.org.eshow_structure.http.entity.mine.content.ContentBody;
import cn.org.eshow_structure.http.entity.mine.content.WriteByteListener;

import static cn.org.eshow_structure.http.entity.HttpMultipartMode.STRICT;
...
public class HttpMultipart {
    ...
    public HttpMultipart(final String subType, final Charset charset, final String boundary) {
        this(subType, charset, boundary, STRICT);
    }
	...
	public ESHttpResponseListener getResponseListener() {
		return responseListener;
	}

	public void setResponseListener(ESHttpResponseListener responseListener) {
