 ...
 */
package com.bangqu.eshow.cache.image;
...
public class ESImageBaseCache implements ESImageCache {
	
	/** LruCache. */
	private static LruCache<String, Bitmap> mCache;
	
	/** AbImageCache 实例. */
	private static ESImageBaseCache mImageCache;

	/**
	 * 构造方法.
	 */
	public ESImageBaseCache() {
		super();
		int maxSize = ESAppConfig.MAX_CACHE_SIZE_INBYTES;
	 ...
	 * @return
	 */
	public static ESImageBaseCache getInstance() {
		if(mImageCache == null){
			mImageCache = new ESImageBaseCache();
		}
		return mImageCache;
	}
