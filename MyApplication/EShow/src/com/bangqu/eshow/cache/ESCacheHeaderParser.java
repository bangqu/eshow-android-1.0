...
/**
 * 
 *AbCacheHeaderParser.java
 */
public class ESCacheHeaderParser {
     ...
     * @return
     */
    public static ESDiskCache.Entry parseCacheHeaders(ESCacheResponse response,long cacheMaxAge) {
           ...
           ESDiskCache.Entry entry = new ESDiskCache.Entry();
