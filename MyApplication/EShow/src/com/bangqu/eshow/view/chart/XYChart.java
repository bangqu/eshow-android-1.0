...
import com.bangqu.eshow.view.chart.XYMultipleSeriesRenderer.Orientation;
...
public abstract class XYChart extends ESstractChart {
   ...
   * @see ESstractChart#getSeriesAndPointForScreenCoordinate(com.bangqu.eshow.view.chart.Point)
   * @author: amsoft.cn
