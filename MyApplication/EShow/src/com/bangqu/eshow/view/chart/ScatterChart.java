...
public class ScatterChart extends XYChart {
   ...
   * @see com.bangqu.eshow.view.chart.XYChart#setDatasetRenderer(com.bangqu.eshow.view.chart.XYMultipleSeriesDataset, com.bangqu.eshow.view.chart.XYMultipleSeriesRenderer)
   * @author: amsoft.cn
   ...
   * @see com.bangqu.eshow.view.chart.XYChart#clickableAreasForPoints(float[], double[], float, int, int)
   * @author: amsoft.cn
   * @date：2013-6-17 上午9:04:49
   */
  @Override
