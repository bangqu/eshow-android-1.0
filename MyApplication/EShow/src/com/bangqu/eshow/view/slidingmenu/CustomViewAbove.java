 ...
 */
package com.bangqu.eshow.view.slidingmenu;
...
import com.bangqu.eshow.view.slidingmenu.SlidingMenu.OnClosedListener;
import com.bangqu.eshow.view.slidingmenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	public static class SimpleOnPageChangeListener implements OnPageChangeListener {
		...
		/* (non-Javadoc)
		 * @see com.bangqu.eshow.view.slidingmenu.CustomViewAbove.OnPageChangeListener#onPageScrolled(int, float, int)
		 */
		public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
			// This space for rent
		}
		...
		/* (non-Javadoc)
		 * @see com.bangqu.eshow.view.slidingmenu.CustomViewAbove.OnPageChangeListener#onPageSelected(int)
		 */
		public void onPageSelected(int position) {
			// This space for rent
		}
