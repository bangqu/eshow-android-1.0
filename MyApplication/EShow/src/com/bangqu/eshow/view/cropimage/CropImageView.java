 ...
 */
package com.bangqu.eshow.view.cropimage;
...
public class CropImageView extends CropViewBase {
     ...
     * @see com.bangqu.eshow.view.cropimage.CropViewBase#onLayout(boolean, int, int, int, int)
     * @author: amsoft.cn
     ...
     * @see com.bangqu.eshow.view.cropimage.CropViewBase#zoomTo(float, float, float)
     * @author: amsoft.cn
     * @date：2013-6-17 上午9:04:49
     */
    @Override
     ...
     *
     * @version v1.0
     * @see com.bangqu.eshow.view.cropimage.CropViewBase#zoomIn()
     * @author: amsoft.cn
     * @date：2013-6-17 上午9:04:49
     */
    @Override
     ...
     *
     * @version v1.0
     * @see com.bangqu.eshow.view.cropimage.CropViewBase#zoomOut()
     * @author: amsoft.cn
     * @date：2013-6-17 上午9:04:49
     */
    @Override
     ...
     * @see com.bangqu.eshow.view.cropimage.CropViewBase#postTranslate(float, float)
     * @author: amsoft.cn
     * @date：2013-6-17 上午9:04:49
     */
    @Override
