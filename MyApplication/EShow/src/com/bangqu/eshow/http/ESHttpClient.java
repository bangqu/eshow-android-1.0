...
import com.bangqu.eshow.cache.http.ESHttpBaseCache;
import com.bangqu.eshow.global.ESAppConfig;
import com.bangqu.eshow.global.ESAppException;
import com.bangqu.eshow.http.entity.MultipartEntity;
import com.bangqu.eshow.http.ssl.EasySSLProtocolSocketFactory;
...
public class ESHttpClient {
    			...
    			try {
    				...
    				if(entry == null || entry.isExpired()){
    					...
    					if(response!=null){
    						...
    						ESLogUtil.i(mContext, "[HTTP GET]:" + httpUrl + ",result：" + responseBody);
    						...
    						if(entryNew!=null){
    							...
    							ESLogUtil.i(ESImageLoader.class, "HTTP 缓存失败，parseCacheHeaders失败");
    						}
	 ...
	 * @param responseListener the response listener
	 */
	public void post(final String url,final ESRequestParams params,
			final ESHttpResponseListener responseListener) {
		responseListener.setHandler(new ResponderHandler(responseListener));
		mExecutorService.execute(new Runnable() { 
    		public void run() {
    			try {
                ...
                if (entity != null){
	  				  if(mResponseListener instanceof ESStringHttpResponseListener){
	                      ...
	                      String charset = EntityUtils.getContentCharSet(entity) == null ? encode : EntityUtils.getContentCharSet(entity);
	      	              ...
	      	              ESLogUtil.i(mContext, "[HTTP GET]:" + request.getURI() + ",result：" + responseBody);
	  					  ...
	  					  ESLogUtil.i(mContext, "[HTTP GET]:" + request.getURI() + ",result：" + fileName);
