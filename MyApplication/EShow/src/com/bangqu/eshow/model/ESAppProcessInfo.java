 ...
 * 
 */
public class ESAppProcessInfo implements Comparable<ESAppProcessInfo>{
	 ...
	 * @param uid the uid
	 */
	public ESAppProcessInfo(String processName, int pid, int uid) {
		super();
	 ...
	 */
	@Override
	public int compareTo(ESAppProcessInfo another) {
