...
public class ChooseYearMonthDayDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWheelViewY = (AbWheelView) findViewById(R.id.wvYear);
        mWheelViewM = (AbWheelView) findViewById(R.id.wvMonth);
        mWheelViewD = (AbWheelView) findViewById(R.id.wvDay);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.tvFinish:
                    ...
                    inputTimeText.setText(AbStrUtil.dateTimeFormat(year + "-" + month + "-" + day));
    ...
    private void initWheelDatePicker() {
        ...
        inputTimeText.setText(AbStrUtil.dateTimeFormat(defaultYear + "-" + defaultMonth + "-" + defaultDay));
