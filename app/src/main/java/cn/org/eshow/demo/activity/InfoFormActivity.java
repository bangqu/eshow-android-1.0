...
public class InfoFormActivity extends FragmentActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        AbLogUtil.d(mContext, "onActivityResult+++++++resultCode:" + resultCode);
        AbLogUtil.d(mContext, "onActivityResult+++++++requestCode:" + requestCode);

        if (resultCode == RETURN_BASEINFO_CODE) {
            AbLogUtil.d(mContext, "onActivityResult+++++++");
        ...
        if (requestCode == BaseInfoFragment.CAMERA_CROP_DATA || BaseInfoFragment.CAMERA_CROP_DATA == requestCode - 65536) {
            ...
            AbLogUtil.d(mContext, "CAMERA_CROP_DATA裁剪后得到的图片的路径是 = " + photo);
            upLoadToQiNiu(photo);
            ...
            AbLogUtil.d(mContext, "选择的图片路径 currentFilePath= " + currentFilePath);
    ...
    private UMAuthListener umAuthListener = new UMAuthListener() {
        ...
        public void onComplete(SHARE_MEDIA platform, int action, Map<String, String> data) {
            ...
            AbLogUtil.d(mContext, "thirdToken:" + thirdToken);
