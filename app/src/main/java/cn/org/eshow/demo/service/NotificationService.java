...
public class NotificationService {
	private XGDBOpenHelper XGDBOpenHelper;
	private static NotificationService instance = null;

	public NotificationService(Context context) {
		this.XGDBOpenHelper = new XGDBOpenHelper(context);
	}
	...
	public void save(XGNotification notification) {
		SQLiteDatabase db = XGDBOpenHelper.getWritableDatabase();
	...
	public XGNotification find(Integer id) {
		SQLiteDatabase db = XGDBOpenHelper.getReadableDatabase();
		Cursor cursor = db
				.query("notification",
