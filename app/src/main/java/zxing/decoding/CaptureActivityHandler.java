...
public final class CaptureActivityHandler extends Handler {
  ...
  private static final String TAG = zxing.decoding.CaptureActivityHandler.class.getSimpleName();

  private final cn.org.eshow.demo.activity.ScanActivity activity;
  private final zxing.decoding.DecodeThread decodeThread;
  private State state;
